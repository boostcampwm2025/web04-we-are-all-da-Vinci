...
| -------------- | ----------------------------------------------------- | --------------------------- |
| `client/`      | React 19 + Vite + TailwindCSS (FSD) — 게임 클라이언트 | See `client/AGENTS.md`      |
| `server/`      | NestJS + Socket.io + Redis — 게임 서버                | See `server/AGENTS.md`      |
| `client-toss/` | Apps-in-Toss WebView 미니앱 (Granite + TDS)           | See `client-toss/AGENTS.md` |
| `server-toss/` | NestJS REST API — 앱인토스 서버                       | See `server-toss/AGENTS.md` |
